...
void test_debug()
{
	debug("I have a Brown Hair.");
	debug("I an %d years old.", 32);
}

void test_log_err()
{
	log_err("I believe everything is broken.");
	log_err("There are %d problems in %s", 0, "spaces");
}
...
int main(int argc, char *argv[])
{
	...
	check(test_check("ex10.c") == 0, "Failed wirh ex20.c");
